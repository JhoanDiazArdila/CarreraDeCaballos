...
public class ControlBurro {
    ...
    public static boolean createBurro(Dueño dueño, String name,
            int age, String raza) throws SQLException {

        try {
            Burro b1 = new Burro(dueño, name, age, raza);
    ...
    public static void showBurroList() {
        try {
            ...
            System.out.println("Error al obtener los Burros: " + ex.getMessage());
            LogManager.logError("CarreraBurros", ex.getMessage(), ex);
            CRUD.cerrarConexion();
        }
    }
